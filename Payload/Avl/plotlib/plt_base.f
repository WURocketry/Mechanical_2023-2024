...
C     
C     Version 4.49  15 Aug 2018  (MD)
C
C     Notes:   
C       Added initialization of window-size parameters to avoid 
C       arithmetic fault in GETWINSIZE when no-plot option is selected
C
C***********************************************************************
